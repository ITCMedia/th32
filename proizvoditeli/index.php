...
//debug($url);
if (count($url) < 4) {
    echo '<div class="proizvoditeli">';
    while ($el = $rsData->fetch()) {
        echo '<a href="/proizvoditeli/'.$el['UF_XML_ID'].'/">'.$el['UF_NAME'] . '</a>';
    }
    echo '</div>';
} else {
    $GLOBALS['arrFilter'] = Array("ACTIVE" => "Y", "PROPERTY" => array('BREND' => array('VALUE' => $url[2])));
    ?>
