...
//---------- template.php ----------//
$MESS['API_AUTH_REGISTER_LOGIN_URL']    = 'Авторизация';
$MESS['API_AUTH_REGISTER_RESTORE_URL']  = 'Вспомнить пароль';
$MESS['API_AUTH_REGISTER_REGISTER_URL'] = '';
$MESS['API_AUTH_REGISTER_BUTTON']       = 'Зарегистрироваться';
$MESS['API_AUTH_REGISTER_REQ']          = '<span class="api-asterisk">*</span>&mdash; обязательные для заполнения поля';
$MESS['API_SOC_AUTH_TITLE']             = 'Войти через социальные сети';

$MESS['REGISTER_USER_DONT_KNOW']            = '(неизвестно)';
$MESS['REGISTER_USER_MALE']                 = 'Мужской';
$MESS['REGISTER_USER_FEMALE']               = 'Женский';
$MESS['REGISTER_FIELD_GROUP_ID']            = 'Группа';
...
$MESS['AUTH_IP_ADDRESS']                    = 'IP-адрес';

//USER_CONSENT
$MESS['API_AUTH_REGISTER_USER_CONSENT_ERROR']         = 'Для продолжения вы должны принять согласие на обработку персональных данных';
$MESS['API_AUTH_REGISTER_USER_CONSENT_TITLE']         = 'Согласие на обработку персональных данных';
$MESS['API_AUTH_REGISTER_USER_CONSENT_FIELDS']        = 'Логин, E-mail, IP-адрес';
$MESS['API_AUTH_REGISTER_USER_CONSENT_BTN_ACCEPT']    = 'Принимаю';
$MESS['API_AUTH_REGISTER_USER_CONSENT_BTN_REJECT']    = 'Не принимаю';
$MESS['API_AUTH_REGISTER_USER_CONSENT_LOADING']       = 'Загрузка..';
$MESS['API_AUTH_REGISTER_USER_CONSENT_ERR_TEXT_LOAD'] = 'Не удалось загрузить текст соглашения.';
