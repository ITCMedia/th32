	...
	ui_vue.Vue.component('bx-messenger-message', {
	  ...
	  methods: {
	    ...
	    gestureQuote: function gestureQuote(eventName, event) {
	      ...
	      var layerX = event.target.getBoundingClientRect().left + event.layerX;
	      var layerY = event.target.getBoundingClientRect().top + event.layerY;
	      ...
	      if (eventName === 'touchstart') {
	        ...
	        this.dragStartTimeout1 = setTimeout(function () {
	          if (_this2.dragMovePositionX !== null && Math.abs(_this2.dragStartPositionY - _this2.dragMovePositionY) >= 10) {
	        ...
	        this.dragStartTimeout2 = setTimeout(function () {
	          ...
	          if (_this2.dragMovePositionX === null) {
	            return;
	          } else if (_this2.dragStartPositionX - _this2.dragMovePositionX < 9) {
	            return;
	          }
	  ...
	  watch: {
	    capturedMoveEvent: function capturedMoveEvent(event) {
	      ...
	      var dragPositionIcon = this.showAvatar ? 20 : 10;
