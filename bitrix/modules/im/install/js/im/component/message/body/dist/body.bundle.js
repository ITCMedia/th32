(function (exports,im_component_element_media,im_component_element_attach,im_component_element_keyboard,ui_vue_components_reaction,ui_vue,im_model,im_const,im_utils) {
	'use strict';
	...
	ui_vue.Vue.component('bx-messenger-message-body', {
	  ...
	  computed: {
	    ...
	    chatColor: function chatColor() {
	      return this.dialog.type !== im_const.DialogType.private ? this.user.color : this.dialog.color;
	    },
