	...
	*/
	...
	public static function Init($arExt = array(), $bReturn = false)
	{
		...
		if ($bNeedCore && !self::isCoreLoaded())
		{
			...
			self::$arCurrentlyLoadedExt['main.core'] = true;
			...
			if (is_array($config['includes']))
            {
                ...
                {
					self::$arCurrentlyLoadedExt[$item] = true;
                }
	...
	{
		return (
			isset(self::$arCurrentlyLoadedExt["core"])
			|| isset(self::$arCurrentlyLoadedExt["main.core"])
        );
	}
