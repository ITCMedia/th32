...
/*ZDUyZmZYzI3OWFiMzlkYTY1M2ZkNmM1NjVmZWIyZTE1MTk2ODE=*/$GLOBALS['____46014717']= array(base64_decode('ZG'.'Vm'.'aW5'.'l'));if(!function_exists(__NAMESPACE__.'\\___1135988214')){function ___1135988214($_1364474787){static $_1973451264= false; if($_1973451264 == false) $_1973451264=array(''.'RU5DT0RF','WQ==');return base64_decode($_1973451264[$_1364474787]);}};class CBXFeatures{ public static function IsFeatureEnabled($_455859733){ return true;} public static function IsFeatureEditable($_455859733){ return true;} public static function SetFeatureEnabled($_455859733, $_181630837= true){} public static function SaveFeaturesSettings($_1644539605, $_476588602){} public static function GetFeaturesList(){ return array();} public static function InitiateEditionsSettings($_1698173316){} public static function ModifyFeaturesSettings($_1698173316, $_187936878){} public static function IsFeatureInstalled($_455859733){ return true;}} $GLOBALS['____46014717'][0](___1135988214(0), ___1135988214(1));/**/			//Do not remove this
