...
<?if($arResult["bDescPageNumbering"] === true):?>
	...
	<?if ($arResult["NavPageNomer"] < $arResult["NavPageCount"]):?>
		<?if($arResult["bSavePage"]):?>
			<li class="pagination-block__prev"><a href="<?=$arResult["sUrlPath"]?>?<?=$strNavQueryString?>PAGEN_<?=$arResult["NavNum"]?>=<?=($arResult["NavPageNomer"]+1)?>"></a></li>
		...
		<?else:?>
			<?if (($arResult["NavPageNomer"]+1) == $arResult["NavPageCount"]):?>
				<li class="pagination-block__prev"><a href="<?=$arResult["sUrlPath"]?><?=$strNavQueryStringFull?>"></a></li>
			<?else:?>
				<li class="pagination-block__prev"><a href="<?=$arResult["sUrlPath"]?>?<?=$strNavQueryString?>PAGEN_<?=$arResult["NavNum"]?>=<?=($arResult["NavPageNomer"]+1)?>"></a></li>
			<?endif?>
		...
		<?endif?>
	<?else:?>
			<!-- <li class="pagination-block__prev"><span></span></li> -->
			<li class="pagination-block__active"><span>1</span></li>
	<?endif?>
	...
	?>
		...
		<?if ($arResult["nStartPage"] == $arResult["NavPageNomer"]):?>
			<li class="pagination-block__active"><span><?=$NavRecordGroupPrint?></span></li>
		<?else:?>
	...
	<?if ($arResult["NavPageNomer"] > 1):?>
		...
		<?endif?>
			<li class="pagination-block__next"><a href="<?=$arResult["sUrlPath"]?>?<?=$strNavQueryString?>PAGEN_<?=$arResult["NavNum"]?>=<?=($arResult["NavPageNomer"]-1)?>"></a></li>
	<?else:?>
		<?if($arResult["NavPageCount"] > 1):?>
			<li class="pagination-block__active"><span><?=$arResult["NavPageCount"]?></span></li>
		<?endif?>
			<!-- <li class="pagination-block__next"><span></span></li> -->
	<?endif?>
...
<?else:?>
	...
	?>
		<?if ($arResult["nStartPage"] == $arResult["NavPageNomer"]):?>
			<li class="pagination-block__active"><span><?=$arResult["nStartPage"]?></span></li>
		<?else:?>
