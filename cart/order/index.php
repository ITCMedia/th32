...
?><?$APPLICATION->IncludeComponent("bitrix:sale.order.ajax", "order", Array(
	"ACTION_VARIABLE" => "soa-action",	// Название переменной, в которой передается действие
		...
		"PATH_TO_AUTH" => "/user/",	// Путь к странице авторизации
		"PATH_TO_BASKET" => "/cart/",	// Путь к странице корзины
		"PATH_TO_PAYMENT" => "/cart/order/payment.php",	// Страница подключения платежной системы
		"PATH_TO_PERSONAL" => "/user/profile.php",	// Путь к странице персонального раздела
